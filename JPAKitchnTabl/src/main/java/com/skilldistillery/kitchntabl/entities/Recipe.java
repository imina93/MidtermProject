...
>>>>>>> 3fd3c153d1f30b74bda9c51bc76f3ef0b715ec70
	public Recipe() {
		super();
	}

	public Recipe(int id, String name, String instructions, int calories, String image, String description,
			int chefRating, String category, String servingSize, int cookTime, int prepTime, int userId,
			List<RecipeIngredient> recipeIngredient, List<RecipeRating> recipeRating) {
		super();
		this.id = id;
		this.name = name;
